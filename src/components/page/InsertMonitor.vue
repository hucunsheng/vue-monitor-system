    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>新增监控</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form-box">
...
<script>
    ...
    export default {
        ...
        created(){
//      		alert(this.$route.query.aaa);
        },
        methods: {
            onSubmit() {
//          		alert(this.form.PARA_SERVICENAME+','+
//          			this.form.PARA_SERVICETHRESHOLD+','+
//          			this.form.PARA_NOTIFYMOBILENO+','+
//          			this.form.PARA_NOTIFYMESSAGE+','+
//          			this.form.PARA_EXPIRE+','+
//          			this.form.PARA_EXPRESSION+','+
//          			this.form.MONITOR_SCHEDULE+','+
//          			this.form.SEND_MSG_VALID_TIME+','+
//          			this.form.date1+','+
//          			this.form.date2+','+
//          			this.form.OPERATOR_SYMBOL+','+
//          			this.form.PRE_COMPARE_SWITCH+','+
//          			this.form.MAPITEM_VALUE);
    			var url  = "/monitor/insertMonitor";                
            // 发送请求:将数据返回到一个回到函数中
...
//			params.append("form",paramsChild);
//			var fd = new FormData()
//			var fd1 = new FormData()
//			fd.append("PARA_SERVICENAME",this.form.PARA_SERVICENAME);
//          fd.append("PARA_SERVICETHRESHOLD",this.form.PARA_SERVICETHRESHOLD);
//          fd.append("PARA_NOTIFYMOBILENO",this.form.PARA_NOTIFYMOBILENO);
//          fd.append("PARA_NOTIFYMESSAGE",this.form.PARA_NOTIFYMESSAGE);
//          fd.append("PARA_EXPIRE",this.form.PARA_EXPIRE);
//          fd.append("PARA_EXPRESSION",this.form.PARA_EXPRESSION);
//          fd.append("MONITOR_SCHEDULE",this.form.MONITOR_SCHEDULE);
//          fd.append("SEND_MSG_VALID_TIME",this.form.SEND_MSG_VALID_TIME);
//          fd.append("OPERATOR_SYMBOL",this.form.OPERATOR_SYMBOL);
//          fd.append("PRE_COMPARE_SWITCH",this.form.PRE_COMPARE_SWITCH);
//          fd1.append("form",fd);
//          alert(qs);
//          var data =  qs.stringify({
//			 
//			    PARA_SERVICENAME : this.form.PARA_SERVICENAME,
//			    PARA_SERVICETHRESHOLD:this.form.PARA_SERVICETHRESHOLD,
//          		PARA_NOTIFYMOBILENO:this.form.PARA_NOTIFYMOBILENO,
//          		PARA_NOTIFYMESSAGE:this.form.PARA_NOTIFYMESSAGE,
//          		PARA_EXPIRE:this.form.PARA_EXPIRE,
//          		PARA_EXPRESSION:this.form.PARA_EXPRESSION,
//          		MONITOR_SCHEDULE:this.form.MONITOR_SCHEDULE,
//          		SEND_MSG_VALID_TIME:this.form.SEND_MSG_VALID_TIME,
//         		OPERATOR_SYMBOL:this.form.OPERATOR_SYMBOL,
//          		PRE_COMPARE_SWITCH:this.form.PRE_COMPARE_SWITCH
//			})
//          alert(data);
